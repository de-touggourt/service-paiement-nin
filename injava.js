...
const gradeMap = {
  ...
  "2031": "مربي متخصص رئيسي في الدعم التر",
  "2100": "مدير مدرسة إبتدائية",
  "3001": "استاذ التعليم المتوسط قسم اول",
  "3005": "استاذ التعليم المتوسط قسم ثاني",
  "3010": "استاذ مميز في التعليم المتوسط",
  "3012": "استاذ التعليم المتوسط",
  "3020": "استاذ ت م متعاقد ق 01 (13)",
  "4000": "مدير متوسطة",
  ...
  "5021": "أستاذ تغليم ثانوي مستخلف",
  "5022": "استاذ مميز في التعليم الثانوي",
  "5023": "استاذ التعليم الثانوي قسم ثان",
  "5024": "استاذ التعليم الثانوي قسم أول",
  "6001": "مدير ثانوية",
  ...
  "6009": "مستشاررئيسي توجيه وارشاد مد م",
  "6010": "مقتصد رئيسي",
  "6015": "مقتصد",
  ...
  try {
    ...
    if (docSnap.exists) {
      ...
      if (String(passInput) === String(userPass)) {
        ...
        // ✅✅ تسجيل حالة الدخول في الجلسة ✅✅
        sessionStorage.setItem("system_logged_in", "true");

        overlay.style.display = 'none'; // إخفاء القفل
        
        // إعادة تهيئة حدث الضغط على Enter
...
// 3️⃣ دالة إدخال المؤكد (معدلة للحفظ التلقائي)
function showConfirmerInput(data) {
    ...
    Swal.fire({
        ...
        if(res.isConfirmed) {
            // 🟢 الحفظ في الجلسة لاستخدامه لاحقاً 🟢
...
// 8️⃣ الطباعة (معدلة للبقاء داخل النظام)
function printA4(d) {
...
// --- كود الاسترجاع التلقائي للجلسة ---
document.addEventListener("DOMContentLoaded", () => {
    if (sessionStorage.getItem("system_logged_in") === "true") {
