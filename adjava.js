...
// دالة طباعة القائمة مع ضمان ظهور التاريخ مباشرة بعد الجدول ومنع انفصاله
window.printNonRegisteredWithNotes = function() {
    ...
    categoryOrder.forEach(category => {
        ...
        fullHTML += `
            <div class="print-page">
                <div class="printable-wrapper"> <div class="official-header">
                        <p>الجمهورية الجزائرية الديمقراطية الشعبية</p>
                        <p>وزارة التربية الوطنية</p>
                        <p>مديرية التربية لولاية توقرت</p>
                        <p>مصلحة تسيير نفقات المستخدمين</p>
    ...
    printWindow.document.write(`
        ...
        <head>
            ...
            <style>
                @page { 
                    size: A4 portrait; 
                    margin: 10mm; /* تقليل الهوامش الخارجية لإعطاء مساحة أكبر */
                }
                * { box-sizing: border-box; }
                body { 
                    font-family: 'Cairo', sans-serif; 
                ...
                .printable-wrapper {
                    page-break-inside: avoid; /* أهم خاصية: تمنع قطع الصفحة بين العناصر الداخلية إذا أمكن */
                    display: flex;
                    flex-direction: column;
                }
                .official-header {
                ...
                .data-table th, .data-table td { 
                    border: 1px solid #000; 
                    padding: 6px 4px; /* تصغير الحشو لتوفير مساحة */
                    text-align: center; 
                    font-size: 11.5px; 
                    height: 30px; 
                ...
                .print-footer-info { 
                    margin-top: 10px; /* تتبع الجدول مباشرة */
                    font-size: 10px; 
                    font-style: italic; 
                    text-align: left; 
                    padding-left: 5px;
